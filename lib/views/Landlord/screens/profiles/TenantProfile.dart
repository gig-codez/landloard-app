...
import '../../../../controllers/PowerConnectionController.dart';
import '/exports/exports.dart';

class TenantProfile extends StatefulWidget {
  final TenantsModel tenantDetails;
  final String id;
  const TenantProfile(
        ...
        child: Column(
          ...
          children: [
                    ...
                    Flex(
                      ...
                      children: [
                        CircleAvatar(
                          ...
                          radius: 45,
                          child: Text(
                            "${widget.tenantDetails.name.split(" ")[0].characters.first.trim()}${widget.tenantDetails.name.split(" ")[1].characters.first.trim().toUpperCase()}",
            ...
            ListTile(
              ...
              subtitle: Text(
                "UGX ${widget.tenantDetails.monthlyRent}",
            ...
            ListTile(
              ...
              subtitle: Text(
                "UGX ${widget.tenantDetails.monthlyRent.toDouble() - 0}",
                style: TextStyles(context).getDescriptionStyle(),
              ),
            ),
            const Divider(),
